...
func TestParse(t *testing.T) {
	cases := []struct {
		...
		{"short-form ip literal host raises", "127.1/kepano/minimal", "", "", "", true},
		{"octal ip literal host raises", "0177.0.0.1/kepano/minimal", "", "", "", true},
		{"hex ip literal host raises", "0x7f.0.0.1/kepano/minimal", "", "", "", true},
